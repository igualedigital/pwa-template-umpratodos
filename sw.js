...
if (workbox) {
    ...
    workbox.precaching.precacheAndRoute([
        ...
        // Arquivos de audio
        { url: base_dir + 'storage/media/audio/sample.mp3', revision: rev_val },
        { url: base_dir + 'storage/media/audio/sample-1.mp3', revision: rev_val },
        { url: base_dir + 'storage/media/audio/sample-2.mp3', revision: rev_val },
        { url: base_dir + 'storage/media/audio/sample-3.mp3', revision: rev_val },
        // Arquivos de video
        { url: base_dir + 'storage/media/video/sample-1.mp4', revision: rev_val },
        { url: base_dir + 'storage/media/video/sample-2.mp4', revision: rev_val },
        { url: base_dir + 'storage/media/video/sample-3.mp4', revision: rev_val },
        { url: base_dir + 'storage/media/video/sample-landscape.mp4', revision: rev_val },
        { url: base_dir + 'storage/media/video/sample-portrait.mp4', revision: rev_val },
        // Arquivos de imagem
        { url: base_dir + 'storage/media/image/sample.jpg', revision: rev_val },
        { url: base_dir + 'storage/media/image/sample-1.jpg', revision: rev_val },
        { url: base_dir + 'storage/media/image/sample-2.jpg', revision: rev_val },
        { url: base_dir + 'storage/media/image/sample-3.jpg', revision: rev_val },
        // Arquivos de texto em formato html
        { url: base_dir + 'storage/media/text/sample.html', revision: rev_val },
        { url: base_dir + 'storage/media/text/sample-1.html', revision: rev_val },
        { url: base_dir + 'storage/media/text/sample-2.html', revision: rev_val },
        { url: base_dir + 'storage/media/text/sample-3.html', revision: rev_val },
